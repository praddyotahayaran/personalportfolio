    ...
    return (
        <div className="intro">
            ...
            <div className="leftIntro">
                ...
                <a className='introBtn' href="https://wa.me/918103740172?text=Hello%20Praddyota%20" target={'blank'}>
                    <button className=" button" style={{width:"6rem"}}>Hire me</button>
                </a>
